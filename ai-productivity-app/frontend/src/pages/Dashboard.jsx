    ...
    <div className="px-4 sm:px-6 lg:px-8 py-8 gradient-bg">
      <main className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            ...
            {health && !error && (
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span
                    className={`text-sm font-medium ${health.status === "ready" ? "text-green-600" : "text-red-600"}`}
                  >
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span
                    className={`text-sm font-medium ${health.database === "ready" ? "text-green-600" : "text-red-600"}`}
                  >
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="mt-4 p-3 bg-blue-50 rounded-md">
            <p className="text-sm text-blue-800">
              <strong>Next:</strong> Phase 3 added project management – see
              below
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6 mt-8">
          ...
          <div className="mt-4 p-3 bg-blue-50 rounded-md">
            <p className="text-sm text-blue-800">
              <strong>Next:</strong> Phase 4 introduced code intelligence – see
              below
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6 mt-8">
          ...
          <div className="mt-4 p-3 bg-blue-50 rounded-md">
            <p className="text-sm text-blue-800">
              <strong>Next:</strong> Phase 5 (in progress) – real-time chat & AI
              assistance
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <ul className="text-sm text-gray-600 space-y-1 list-disc list-inside">
                ...
                <li>
                  Slash commands (e.g. <code>/explain</code>,{" "}
                  <code>/generate-tests</code>)
                </li>
              </ul>
            </div>
            <div>
