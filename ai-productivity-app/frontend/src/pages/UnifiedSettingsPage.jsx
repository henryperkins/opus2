        ...
        return (
          <div className="space-y-8">
            <div className="text-center text-gray-500 dark:text-gray-400 py-8">
              <p>
                Thinking and tools configuration has been consolidated into the
                AI Models section.
              </p>
              ...
              return (
                <li key={section.id}>
                  <button
                    ...
                    className={`w-full flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors ${NavigationManager.getActiveStyles(
                      isActive,
                      "sidebar",
                    )}`}
                  >
        ...
        <div>
          <label className="flex items-center justify-between">
            ...
            <input
              ...
              onChange={(e) =>
                setPreference("emailNotifications", e.target.checked)
              }
              className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
            />
          </label>
        ...
        <div>
          <label className="flex items-center justify-between">
            ...
            <input
              ...
              onChange={(e) =>
                setPreference("pushNotifications", e.target.checked)
              }
              className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
            />
          </label>
