  ...
  const renderSkeleton = (index) => {
    ...
    switch (type) {
      ...
      case 'websocket-connecting':
        return (
          <div key={index} className={`flex items-center justify-center p-4 ${className}`}>
            <div className="flex items-center space-x-3">
              <div className="w-6 h-6 border-2 border-blue-600 border-t-transparent rounded-full animate-spin"></div>
              <span className="text-sm text-gray-600">Connecting to chat...</span>
            </div>
          </div>
        );
      ...
      case 'model-switching':
        return (
          <div key={index} className={`flex items-center space-x-3 p-3 bg-yellow-50 rounded-lg ${className}`}>
            ...
            <span className="text-sm text-yellow-800">Switching AI model...</span>
          </div>
        );
