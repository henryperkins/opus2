...
const TOOLTIP_CONTENT = {
  "search-modes": {
    title: "Search Modes",
    content:
      "Semantic (by meaning), Keyword (exact text), Structural (code patterns), or Hybrid (all modes).",
    docTab: "search",
  ...
  "rag-status": {
    title: "RAG Status",
    content:
      "Green = Knowledge found, Yellow = Low confidence, Red = Error, Gray = No knowledge used. Confidence % shows source reliability.",
    docTab: "rag",
  ...
  citations: {
    title: "Citations",
    content:
      "Click citation numbers [1], [2] to view sources. Higher confidence % means more reliable information.",
    docTab: "rag",
  ...
  "knowledge-upload": {
    ...
    content:
      "Upload documents, connect repositories, or add knowledge entries to improve AI responses.",
    docTab: "knowledge",
  ...
  "confidence-score": {
    ...
    content:
      "Shows how reliable the AI's sources are. 80%+ is high confidence, 60-80% is moderate, below 60% is low.",
    docTab: "rag",
  ...
  "effective-queries": {
    ...
    content:
      "Ask specific questions with context. Use structural syntax like 'function:name' for code searches.",
    docTab: "chat",
