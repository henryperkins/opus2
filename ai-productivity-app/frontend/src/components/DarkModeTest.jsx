    ...
    <div className="p-8 space-y-4">
      ...
      <div className="p-4 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 rounded-lg border border-gray-300 dark:border-gray-700">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">
          This should have white background in light mode and dark gray in dark
          mode.
        </p>
      </div>
      ...
      <div className="space-y-2">
        <div className="test-dark-mode p-4 rounded">
          Test CSS: .test-dark-mode
        </div>
        <div className="test-dark-mode-where p-4 rounded">
          Test CSS: .test-dark-mode-where
        </div>
        <div className="test-dark-mode-html p-4 rounded">
          Test CSS: .test-dark-mode-html
        </div>
        <div className="test-dark-mode-descendant p-4 rounded">
          Test CSS: .test-dark-mode-descendant
        </div>
      </div>
