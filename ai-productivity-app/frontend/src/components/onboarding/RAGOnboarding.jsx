...
const RAG_ONBOARDING_STEPS = [
  {
    ...
    content:
      "Your AI assistant can now search through your uploaded documents, code, and knowledge base to provide more accurate and contextual responses.",
    action: "Get Started",
    highlight: null,
  },
  {
    ...
    content:
      "Start by uploading documents, connecting repositories, or adding knowledge entries. The more you add, the smarter your assistant becomes.",
    action: "Show Me How",
  ...
  },
  {
    ...
    content:
      "Try asking questions like 'How does the authentication work?' or 'What's the deployment process?' - your assistant will search your knowledge base for answers.",
    action: "Try It",
  ...
  },
  {
    ...
    content:
      "Look for the RAG status indicator and citations to see what sources informed each response. You can click citations to view the original content.",
    action: "Got It",
        ...
        <div className="mb-6">
          ...
          <div className="w-full bg-gray-200 rounded-full h-2">
            <div
              ...
              style={{
                width: `${((currentStep + 1) / RAG_ONBOARDING_STEPS.length) * 100}%`,
              }}
            />
          </div>
        </div>
            ...
            <div className="bg-purple-50 border border-purple-200 rounded-lg p-4 mt-4">
              ...
              <div className="grid grid-cols-1 gap-2">
                {currentStepData.examples.map((example, index) => (
                  <div
                    key={index}
                    className="bg-white border border-purple-200 rounded-md p-2 text-sm text-purple-700"
                  >
                    "{example}"
                  </div>
                ))}
            ...
            <div className="bg-orange-50 border border-orange-200 rounded-lg p-4 mt-4">
              ...
              <ul className="space-y-1">
                {currentStepData.features.map((feature, index) => (
                  <li
                    key={index}
                    className="flex items-center text-orange-700 text-sm"
                  >
