          ...
          <div className="space-y-4">
            <div className="grid gap-3">
              <div className="flex justify-between items-center">
                ...
                <kbd className="px-2 py-1 text-xs font-mono bg-gray-100 dark:bg-gray-700 rounded">⌘ K</kbd>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-600 dark:text-gray-400">New chat</span>
                <kbd className="px-2 py-1 text-xs font-mono bg-gray-100 dark:bg-gray-700 rounded">N</kbd>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-600 dark:text-gray-400">Focus chat input</span>
                <kbd className="px-2 py-1 text-xs font-mono bg-gray-100 dark:bg-gray-700 rounded">⌘ J</kbd>
              </div>
              <div className="flex justify-between items-center">
        ...
        >
          <div className="space-y-6">
            <div className="prose dark:prose-invert max-w-none">
              ...
              <p>Welcome to AI Productivity! This application helps you manage projects, chat with AI, and organize your knowledge base.</p>
              
              <h3>Key Features</h3>
              <ul>
                <li><strong>Projects:</strong> Organize your work into projects with chat, files, and knowledge bases</li>
                <li><strong>AI Chat:</strong> Interact with AI models for assistance and collaboration</li>
                <li><strong>Knowledge Base:</strong> Upload and search through documents and files</li>
                <li><strong>Code Analysis:</strong> Get AI assistance with your code repositories</li>
              </ul>
