...
import { isActivePath, generateBreadcrumbs, getNavigationItems } from '../navigationUtils';
...
describe('navigationUtils', () => {
  describe('isActivePath', () => {
    ...
    it('should handle URL encoding', () => {
      ...
      expect(isActivePath('/projects/hello%20world', '/projects/hello world')).toBe(true);
    });
  ...
  describe('getNavigationItems', () => {
    ...
    it('should filter by showMobileQuickAction', () => {
      ...
      expect(items.every(item => item.showMobileQuickAction === true)).toBe(true);
    });
