        ...
        try:
            ...
            result = {
                ...
                "expansion_metadata": {
                    ...
                    "confidence_score": self._calculate_expansion_confidence(combined_expansions)
                }
            }
...
Return only the context-aware queries, one per line."""
    ...
    async def _expand_with_semantic_similarity(self, query: str) -> List[Dict[str, Any]]:
    ...
    def _calculate_expansion_confidence(self, expansions: List[Dict[str, Any]]) -> float:
