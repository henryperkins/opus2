    ...
    async def summarize_overflow_chunks(
        ...
        for chunk in overflow_chunks:
            ...
            if metadata.get("start_line"):
                chunk_text += f" (lines {metadata['start_line']}-{metadata['end_line']})"
...
Summary:"""
        ...
        try:
            ...
            file_list = [chunk.get("metadata", {}).get("file_path", "Unknown") 
                        for chunk in overflow_chunks]
...
Summary:"""
    ...
    def should_summarize_chunks(
        ...
        for chunk in sorted_chunks:
            ...
            if current_tokens + chunk_tokens <= max_context_tokens and len(kept_chunks) < keep_top_n:
