...
class PromptService:
    ...
    async def get_template(self, template_id: int, user_id: int) -> Optional[PromptTemplate]:
    ...
    async def duplicate_template(
        ...
        try:
            ...
            logger.info(f"Duplicated prompt template {template_id} to {new_template.id}")
            return new_template
        except Exception as e:
            self.db.rollback()
