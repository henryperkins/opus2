...
class CacheMetrics:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "avg_hit_time": sum(self.operation_times['hit']) / len(self.operation_times['hit']) if self.operation_times['hit'] else 0,
            "avg_miss_time": sum(self.operation_times['miss']) / len(self.operation_times['miss']) if self.operation_times['miss'] else 0
        }
...
class CacheService:
    ...
    async def cache_embedding(self, text: str, embedding: List[float], ttl: float = 3600):
    ...
    async def cache_search_result(self, 
                                 query: str, 
