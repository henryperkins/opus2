...
class ConfidenceService:
    ...
    def _calculate_result_confidence(
        self, result: Dict[str, Any], user_feedback_history: Optional[List[Dict]] = None
    ) -> float:
        ...
        feedback_conf = self._calculate_feedback_confidence(
            result, user_feedback_history
        )
    ...
    def _calculate_feedback_confidence(
        self, result: Dict[str, Any], feedback_history: Optional[List[Dict]] = None
    ) -> float:
