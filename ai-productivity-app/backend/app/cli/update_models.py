...
async def update_models():
    ...
    async with AsyncSessionLocal() as session:
        ...
        existing_models_dict = {
            ...
            for model in existing_models.scalars().all()
        }
        ...
        for model_data in fixture_models:
            ...
            if model_id in existing_models_dict:
                ...
                if "deprecated_at" in model_data and isinstance(model_data["deprecated_at"], str):
                    model_data["deprecated_at"] = parse_datetime(model_data["deprecated_at"])
                elif model_data.get("is_deprecated", False) and "deprecated_at" not in model_data:
