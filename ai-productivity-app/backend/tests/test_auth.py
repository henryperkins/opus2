...
class TestUserLogin:
    ...
    def test_login_invalid_credentials(self, test_user):
        ...
        data = {"username_or_email": test_user.username, "password": "wrongpassword"}
        response = client.post("/api/auth/login", json=data)
    ...
    def test_login_nonexistent_user(self):
        ...
        data = {"username_or_email": "nonexistent", "password": "password123"}
        response = client.post("/api/auth/login", json=data)
...
class TestPasswordReset:
    ...
    def test_submit_password_reset_invalid_token(self):
        ...
        data = {"token": "invalidtoken", "new_password": "newpassword123"}
        response = client.post("/api/auth/reset-password/submit", json=data)
...
class TestUserModel:
    ...
    def test_username_validation(self, db: Session):
        ...
        # Valid username
        user = User(
            username="validuser", email="valid@example.com", password_hash="hash"
        )
